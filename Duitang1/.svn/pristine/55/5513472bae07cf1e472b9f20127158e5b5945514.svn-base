...
- (void)viewDidLoad {
    ...
    [self.imageView sd_setImageWithURL:[NSURL URLWithString:self.photo_path] placeholderImage:[UIImage imageNamed:@"12.jpeg"]];
...
//     UIImageWriteToSavedPhotosAlbum(self.imageView.image, nil, nil, nil);
    Pictures * picture = [[Pictures alloc] init];
    picture.image = self.photo_path;
    [[Manager sharedManager] insertPictures:picture];
    [picture release];
