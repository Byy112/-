...
@interface HotListsViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateWaterfallLayout,NetWorkRequestDelegate>
...
@implementation HotListsViewController
