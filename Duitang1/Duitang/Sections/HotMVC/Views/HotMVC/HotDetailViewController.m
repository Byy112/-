...
@interface HotDetailViewController ()<NetWorkRequestDelegate>
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[HotDetailCell class] forCellReuseIdentifier:@"hotdetailcell"];
...
//    NSLog(@"arr = %@",[[Manager sharedManager] selectUser]);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        HotDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:@"hotdetailcell" forIndexPath:indexPath];
