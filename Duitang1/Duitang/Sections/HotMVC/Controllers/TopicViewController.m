...
- (void)viewDidLoad {
    ...
    [request startNetWorkRequestWithURL:[@"http://www.duitang.com/napi/topic/detail/?__dtac=%257B%257D&topic_id=" stringByAppendingString:url1] method:nil parameters:nil kind:2 orContainChinese:NO];
