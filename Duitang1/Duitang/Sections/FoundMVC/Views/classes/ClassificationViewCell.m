...
@interface ClassificationViewCell ()
@property (nonatomic, assign)CGRect rect;
@end

@implementation ClassificationViewCell
...
//        
//        self.sender_avatar.userInteractionEnabled = YES;
//        //为头像添加手势
//        UITapGestureRecognizer * tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(click:)];
       
//        [self.sender_avatar addGestureRecognizer:tap];
      ...
      //  self.sender_username.backgroundColor = [UIColor cyanColor];
        ...
        //self.album_name.backgroundColor = [UIColor greenColor];
...
- (void)enterAnotherViewController:(UITapGestureRecognizer *)tap {
    ...
    FoundDetailTableViewController *hot = [[FoundDetailTableViewController alloc]init];
    //把id值传过去
