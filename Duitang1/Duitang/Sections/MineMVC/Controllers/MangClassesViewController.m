...
#import "MangClassCollectionViewCell.h"
#import "HotModel.h"
...
@interface MangClassesViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateWaterfallLayout,NetWorkRequestDelegate>
...
@implementation MangClassesViewController
...
- (void)createCollectionView {
    ...
    [self.collectionView registerClass:[MangClassCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row < self.dataArr.count) {
        MangClassCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == self.dataArr.count) {
        ...
        if (self.target_idHeader != nil) {
            ...
            NSString * str = [NSString stringWithFormat:@"start=%ld&album_",(long)self.loadCount];
